  ...
  return {
    ...
    implementation: {
      surfaces: [
        ...
        "Hosted one-click tester endpoint that runs the scenario, verifies a receipt, mints a proof hash, and returns the GitHub issue URL without cloning the repo.",
