...
export const rubricScorecard: RubricScorecardItem[] = [
  ...
  },
  {
    ...
    evidence:
      "The app tracks paid reads, answer settlements, citation receipts, citation tolls, buyer-agent runs, USDC moved, creators paid, source catalog size, registered/RSS-imported sources, impact-pool grants, signed creator webhooks, creator cash-outs, A2A proof events, and payout splits in the live ledger.",
    fullMarksMove:
...
export function estimatedRubricReadiness() {
  return {
    totalPct: 97,
    verdict:
      "Submission-ready product shape with live Gateway verification, a real Circle CLI paid request, answer-linked citation settlement, claim-level answer proofs, signed creator webhooks, creator cash-outs, source onboarding, RSS/Ghost import, publisher kit, retroactive impact pool, and bonded A2A proof; the remaining gap to a true 100/100 is external tester/creator traction before July 6.",
  };
}
