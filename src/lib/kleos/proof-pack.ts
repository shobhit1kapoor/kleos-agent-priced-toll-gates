...
export function buildProofPack(origin?: string) {
  ...
  return {
    ...
    strongestDifferentiators: [
      ...
      "Traction campaign kit: role-specific tester links, curl payloads, Discord copy, X copy, and validation gates make external feedback repeatable.",
      ...
      "Public traction command center: /traction shows live GitHub gates, role-specific invite links, outreach copy, and proof links in one reviewer-readable surface.",
      ...
      "Public operations proof: status, health, treasury, and OpenAPI endpoints let reviewers verify scope and liveness without a guided demo.",
      "Proof explorer: /proof turns the live x402 receipt, verification certificate, transparency root, impact graph, and traction gates into a reviewer-readable audit console.",
      "Submission certificate: /api/provenance and /api/submission/certificate tie deployment, GitHub repo, CI, Circle x402 receipt, and traction gates into one machine-readable proof.",
      "Submission evidence bundle: /api/submission/bundle packages form fields, demo script, proof links, tester invite links, validation gates, and a bundle hash for reviewers.",
      ...
      "Economic invariant CI: budget caps, split totals, receipt links, registry records, vault gates, A2A gates, and validation checks are covered by scripts/invariant-check.ps1 and GitHub Actions.",
