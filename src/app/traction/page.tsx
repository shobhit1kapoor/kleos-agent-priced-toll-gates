...
const roleOrder = ["creator", "builder", "agent-operator", "judge", "other"] as const;
...
export default async function TractionPage() {
  const [githubTraction, certificate, ...invitePackets] = await Promise.all([
        ...
        <div className="mt-6 grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(360px,0.72fr)]">
          ...
          <section className="rounded-xl border border-[#e0e0dc] bg-white shadow-sm">
            <SectionHeader
              ...
              description="Creator and builder/operator roles matter most because they close separate judge-visible traction gates."
        ...
        <div className="mt-6 grid gap-5 xl:grid-cols-[minmax(0,0.92fr)_minmax(360px,0.8fr)]">
          ...
          <section className="rounded-xl border border-[#e0e0dc] bg-white shadow-sm">
            <SectionHeader
              ...
              description="These are the pages and endpoints a reviewer can use without a guided demo."
