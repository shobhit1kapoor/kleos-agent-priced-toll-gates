  ...
  return Response.json(
    {
      ...
      proofLinks: {
        ...
        proofExplorer: "https://kleos-agent-priced-toll-gates.vercel.app/proof",
        creatorEarnings: "https://kleos-agent-priced-toll-gates.vercel.app/creators",
        ...
        publisherVerification: "https://kleos-agent-priced-toll-gates.vercel.app/api/publishers/verify",
        reputationPassport: "https://kleos-agent-priced-toll-gates.vercel.app/api/reputation/passport",
        agentSpendPermits: "https://kleos-agent-priced-toll-gates.vercel.app/api/agents/spend-permits",
      ...
      evidence: {
        ...
        differentiators: [
          ...
          "Publisher ownership verifier that prevents source squatting by binding a wallet to a domain challenge.",
          "ERC-8004-ready reputation passport for buyer agents, creators, publishers, and the Kleos settlement agent.",
          "Budget-capped agent spend permits for external agents, with policy digests, per-toll caps, expiry, and audit hashes.",
